jsGB = {
  ...
  reset: function() {
    ...
    document.getElementById('col_set').onclick=jsGB.dbgsetColors;
  ...
  dbgsetColors: function() {
  	var white = document.getElementById('col_white');
  	var lgray = document.getElementById('col_lgray');
  	var dgray = document.getElementById('col_dgray');
  	var black = document.getElementById('col_black');

  	GPU._colors.white = white.value.split(',');
  	GPU._colors.lgray = lgray.value.split(',');
  	GPU._colors.dgray = dgray.value.split(',');
  	GPU._colors.black = black.value.split(',');
  },

  dbggetColors: function() {
  	var white = GPU._colors.white.toString();
  	var lgray = GPU._colors.lgray.toString();
  	var dgray = GPU._colors.dgray.toString();
  	var black = GPU._colors.black.toString();

  	document.getElementById('col_white').value = white;
  	document.getElementById('col_lgray').value = lgray;
  	document.getElementById('col_dgray').value = dgray;
	document.getElementById('col_black').value = black;
  },
